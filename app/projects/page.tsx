...
import { Arrow, DayHQIcon, DevelopmentBadge, PlatformPills } from "@/components/public/public-art";
...
export default function ProjectsPage() {
  return <PublicShell>
    <section className="public-hero public-hero-solo"><div className="public-hero-copy"><p className="public-eyebrow">Projects</p><h1>Ideas<br /><span className="public-accent">taking shape.</span></h1><p className="public-lead">Mobile apps, useful tools, and experiments in progress.</p></div></section>
    <article className="public-project public-section" aria-labelledby="dayhq">
      <div className="public-project-heading"><div><p className="public-eyebrow">01 / Mobile app</p><div className="public-app-id"><DayHQIcon /><h2 id="dayhq">DayHQ</h2></div><PlatformPills /></div><DevelopmentBadge /></div>
